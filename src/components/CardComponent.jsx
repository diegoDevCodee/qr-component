const CardComponent = () => {
  return (
    <div className="bg-whiteText p-4 w-full sm:w-[18rem] rounded-2xl flex flex-col gap-5">
      ...
      <div className="px-4 sm:px-3">
        <h1 className="text-darkBlue sm:text-xl font-bold text-center text-[1.6rem]">
          Improve your front-end skills by building projects
        </h1>
        <p className="text-center text-grayishBlue text-lg sm:text-sm pt-3 pb-8 sm:pb-6">
